        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLocationLng = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryLocationLat = table.Column<double>(type: "double precision", nullable: false),
                    DeliveryLocationLng = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourierLocationHistory_Couriers_CourierId",
                        column: x => x.CourierId,
                        principalTable: "Couriers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourierLocationHistory_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourierLocationHistory_CourierId_RecordedAt",
                table: "CourierLocationHistory",
                columns: new[] { "CourierId", "RecordedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_CourierLocationHistory_OrderId",
                table: "CourierLocationHistory",
                column: "OrderId");
